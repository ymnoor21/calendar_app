...
define('DEFAULT_PAGE', '/signin');
define('APP_NAME', 'MyCalendar.App');
define('ADMIN_NAME', 'Yamin Noor');
define('ADMIN_EMAIL', 'ymnoor21@gmail.com');

define('MAX_P_COUNT', 5);
define('STARTING_YEAR', date("Y"));
